...
class Asset(models.Model):
    ...
    admin = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE, verbose_name='资产管理员', related_name='admin')
    ...
    approved_by = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE, verbose_name='批准人', related_name='approved_by')
